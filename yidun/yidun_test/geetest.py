...
from get_trace import _generate_trace
from chaojiying import image_to_text
from img_locate import _get_distance, make_word, _pic_download, merge_word
from encrypt import _reload_js, _encrypt_slider, _encrypt_click
from encrypt import _encrypt_sense, _get_cb, _get_fp, _encrypt_validate
...
class YidunCracker:
    ...
    def __init__(self, sid, width):
        ...
        self.fp = "Z1+ZTRdPKV2+WjqWqgnB7ltrluDKansTDDondrGQC6wx/4oQ36MmLMd6\\lmwu5fer8uy+d\\\\BPI3tzopUAVXbdfLxsMgoHcDqDlndY\\N5l4yVL2TBr4VaduksTyD5UfJSIyYM3HJUIRRaTr8wibwjnP87ZZqR5oX2LZ++5qm\\NacAh5\\:1587730881443"
    ...
    def _init_captcha(self):
        ...
        params = {
            ...
            'cb': "zxrCWjxh1LOc9uSCl/bZ8/gVjqaY\\89oL+vLnFibG/xKkuavl6TjITiwlUpg/66T",
            'ipv6': 'false',
            'runEnv': 10,
            'width': '0',
            'token': self.token,
