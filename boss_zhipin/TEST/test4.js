...
function get_analysis_v2() {
    var url = "https://api.qimai.cn/search/index";
    var m = [ 'cn', '恐龙', 'ios12' ];
    var e = +new Date - 1105735 - 1515125653845;
    m = m.sort().join(""); //"2019-07-155000allcniphone"
    src = CryptoJS.enc.Utf8.parse(m);
...
console.log(get_analysis("https://api.qimai.cn/search/index", ["cn", "恐龙", "ios12"]));

console.log(get_analysis_v2());

