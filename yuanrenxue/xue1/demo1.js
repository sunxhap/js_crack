...
window.b = '';
window.c = 24 - 6;  // $('script').size() - 6; // 24
document.d = String;
...
window['btoa'] = new Base64().encode;
window['atob'] = new Base64().decode;
...
function oo0O0(mw) {
    ...
    console.log('\x27' + mw + '\x27');

    // eval(atob(window['b'])[J('0x0', ']dQW')](J('0x1', 'GTu!'), '\x27' + mw + '\x27'));
    // atob(window['b']).replace('mwqqppz', '\x27' + mw + '\x27');
    // console.log(atob(window['b']).replace('mwqqppz', '\x27' + mw + '\x27'));
...
var m_result = oo0O0(timestamp_str) + window.f;
var list = {"page": window.page, "m": m_result + '丨' + timestamp / 1000};

console.log(list);

//  a62e27ac2bd4264c243800490413d344丨1603285940
//  66b9e140f069565ed2b9accb40c00f62丨1603286221