window.NECaptcha = function(e) {
    ...
    , function(e, t, n) {
        ...
        var o, a, l = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            ...
            , s = n(1), u = n(18), f = document.createElement("div"), c = /^(?:click|dblclick|contextmenu|DOMMouseScroll|(mouse|touch|pointer)(?:\w+))$/, j = document;
    ...
    , function(e, t, n) {
        ...
        var o, a = n(1), l = n(2), s = n(3), u = s.CAPTCHA_TYPE, f = s.CAPTCHA_CLASS, c = s.WIDTH_LIMIT, j = s.RTL_LANGS, d = s.FEEDBACK_URL, h = n(15), p = n(18), y = n(4), v = y.SWITCH_TYPE, g = y.INVOKE_HOOK, b = y.EVENT_RESET, m = y.SWITCH_LOAD_STATUS, _ = y.UPDATE_VERIFY_STATUS, T = y.REFRESH, w = y.EVENT_RESET_CLASSIC, S = y.SET_TOKEN, E = n(12), R = E.FETCH_CAPTCHA, C = E.VERIFY_CAPTCHA, k = E.RESET_STATE, O = n(26), $ = n(27), X = n(28), I = n(25);
        e.exports = {
            el: ".yidun",
            template: n(55),
            props: {
            ...
            on: (o = {},
                ...
                i(o, ".yidun_tips click", function() {
                    var e = this.$store.state
                        ...
                        , i = e.verifyStatus;
                    "error" === i && n > t.maxVerification && this.$store.commit(w)
                }),
                o),
            watch: {
            ...
            methods: {
                ...
                updateVerifyStatus: function(e, t) {
                    var n = this
                        ...
                        , j = l.find(".yidun_slider__icon--img", this.$el)
                    ...
                    switch (e) {
                        ...
                        case "success":
                            this.resetClassNames(i + "--" + r),
                                ...
                                l.addClass(c, "hide"),
                                T(p.slideIconSuccess);
                            break;
                        case "error":
                            var w = _ > m.maxVerification
                                , S = i + "--" + a
                                , E = w ? S + " yidun--maxerror" : S;
                            this.resetClassNames(E),
                                w ? l.text(s, b.verifyOutOfLimit) : this.captchaType === u.JIGSAW ? l.text(s, "") : l.text(s, b.verifyError),
                                l.addClass(c, "hide"),
                                T(p.slideIconError),
        ...
        e.exports = function(e, t) {
            ...
            if (e && n) {
                var o = r.uuid()
                    ...
                    , l = Object.assign([["NECaptcha-color__" + o, a]]);
                i(l, t)
            }
        }
    }
    , function(e, t, n) {
        ...
        var r, o = n(21), a = n(17), l = n(5), s = l.REQUEST_SCRIPT_ERROR, u = l.REQUEST_API_ERROR, f = l.REQUEST_IMG_ERROR, c = l.BUSINESS_ERROR, j = l.UNPASS_ERROR, d = l.ANTICHEAT_TOKEN_ERROR, h = n(20), p = n(8), y = n(1), v = y.uuid, g = (r = {},
            i(r, u, "api"),
            i(r, f, "image"),
            i(r, s, "script"),
            i(r, c, "business"),
    ...
    , function(e, t, n) {
        ...
        !function() {
            ...
            "undefined" != typeof e && e.exports ? e.exports = a : "object" === o(n(23)) && n(23) ? (i = [],
                r = function() {
                    return a
                }
                    .apply(t, i),
                ...
                verifyIntellisenseCaptcha: function() {
                    var e = this
                        ...
                        e.$store.dispatch(o, {
                            ...
                            data: JSON.stringify({
                                d: "",
                                m: v(p.sample(l, h).join(":")),
                                p: v(a),
                                ext: v(g(n, "1," + l.length))
                            })
                        }, function(t) {
                            if (e._isMounted) {
                                if (!t)
            ...
            methods: {
                ...
                initCustomStyles: function() {
                    ...
                    this.$picViews[0].view.style.borderTopLeftRadius = e.borderRadius,
                        this.$picViews[b - 1].view.style.borderTopRightRadius = e.borderRadius,
                        this.$picViews[b].view.style.borderBottomLeftRadius = e.borderRadius,
                        this.$picViews[b * m - 1].view.style.borderBottomRightRadius = e.borderRadius
                },
                reset: function() {
                    var e = this.$store.state
    ...
    , function(e, t, n) {
        ...
        var r, o = n(6), a = n(2), l = n(1), s = n(7), u = s.eypt, f = s.xor_encode, c = n(3), j = c.CAPTCHA_TYPE, d = c.CAPTCHA_CLASS, h = c.SAMPLE_NUM, p = c.RTL_LANGS, y = n(4), v = y.SWITCH_LOAD_STATUS, g = y.INVOKE_HOOK, b = n(5), m = b.REQUEST_IMG_ERROR, _ = n(8), T = n(9);
        e.exports = o._extend({
            "abstract": !0,
            ...
            methods: {
                ...
                onClick: function(e) {
                    ...
                    if (!o) {
                        ...
                        return f && e.target === f.el && !this.$store.state.verifyStatus ? void l.raf(function() {
        ...
        function i(e) {
            ...
            var n = window.gdxidpyhxde
                ...
                onVerify: function(t, n) {
                    if (t) {
                        var i = t.data;
                        if (i && i.counts > e.maxVerification) {
                            var r = new m(_,"verify failed more then " + e.maxVerification + " times--" + t.message,Object.assign({
                                token: i.token
                            }, t.data));
                            return void w(r, e)
                        }
            ...
            this.version = o.state.version,
                ...
                this.lang = e.lang;
            var X = o.subscribe(function(n, i) {
                var r = n.type
                    , o = n.payload;
                switch (r) {
                    case a:
            ...
            methods: {
                    ...
                    var n = function(n) {
                        R.all([new R(function(i, r) {
                                var o = t.$store.state.token
                                    ...
                                    , u = l.top
                                    , f = v.now()
                                    , c = T(o, [Math.round(e.clientX - s), Math.round(e.clientY - u), f - (t.beginTime || f)] + "")
                ...
                updateUI: function(e) {
                    ...
                    switch (g.off(i, "click", u),
                        ...
                        case "error":
                            var f = o + "--error";
                            l > s.maxVerification ? (f += " " + o + "--maxerror",
    ...
    , function(e, t, n) {
        ...
        function r(e, t) {
            ...
            var s = r;
            return o && a ? s = u.isMobile ? "260px" : m + "px" : (i(r) || Number(r)) && (s = r + "px"),
                s
        }
        function o(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
        ...
        function l(e) {
            ...
            f.assert(e.captchaId, 'config: "captchaId" is required!'),
                f.assert(l || n, 'config: "element" is required when "mode" is not "popup"'),
            ...
            var s = e.appendTo;
            return !t && "popup" === e.mode || "bind" === e.mode || t && u.isMobile ? f.assert(!s || s.nodeType || "string" === f.typeOf(s), "config: appendTo should be a elment or string") : f.assert(!s, 'config: appendTo could only be valid when aptchaType is not intellisense and mode is "popup", or mode is bind, or captchaType is intellisense on the mobile side'),
            s && !s.nodeType && "string" === f.typeOf(s) && (s = u.find(s),
                f.assert(s, 'config: "element ' + e.appendTo + '" which "appendTo" defined not found'),
                e.appendTo = s),
            s && "static" === u.getComputedStyle(s, "position") && (s.style.position = "relative"),
            ...
            !function() {
                ...
                !function() {
                    ...
                    !function() {
                        ...
                        function F() {
                            var e = B();
                            return null == e || void 0 == e || e == s[0] ? t[9] : (e = Y(e),
                        ...
                        function W() {
                            ...
                            try {
                                ...
                                null == L || L.length % ie != t[9])
                                    throw Error(u[83]);
                                I = [];
                                for (var B = t[9], F = L.length / ie, H = t[9]; H < F; H++) {
                                    I[H] = [];
                                ...
                                for (var K = I.length, q = t[9]; q < K; q++) {
                                    ...
                                    null == F)
                                        ...
                                        for (var ce = b(t[91]), H = [], je = F.length, ve = t[9]; ve < je; ve++)
                                            H.push(v(F[ve], ce--));
                                        re = H
                                    }
                                    if (F = re,
                                    null == F)
                                        ...
                                        for (var ge = b(t[110]), H = [], _e = F.length, Te = t[9]; Te < _e; Te++)
                                            H.push(g(F[Te], ge++));
                                        J = H
                                    }
                                    var we, Se = y(J, C);
                                    ...
                                    null == F)
                                        ...
                                        for (var z = [], Ee = H.length, Re = t[9], Ce = F.length; Re < Ce; Re++)
                                            z[Re] = b(F[Re] + H[Re % Ee]);
                                        we = z
                                    }
                                    var Se = y(we, k)
                                        , ke = i(Se)
                                        , ke = i(ke);
                                    c(ke, t[9], B, q * ie + ae, ie),
                                        k = ke
                                }
                                var Oe;
                                if (null == B || void 0 == B)
                                    Oe = null;
                                else if (B.length == t[9])
                                    Oe = s[0];
                                else {
                                    var $e = t[13];
                                    try {
                                        for (var K = [], Xe = t[9]; Xe < B.length; ) {
                                            if (!(Xe + $e <= B.length)) {
                                                K.push(a(B, Xe, B.length - Xe));
                                                break
                                            }
                                            K.push(a(B, Xe, $e)),
                                                Xe += $e
                    ...
                    j(m, b, function(e, t) {
                        if (e = o(e, t, m),
                            e ? e = new M(e.code,e.message,{
                                ...
                                token: b.token,
                                type: f
                            }) : X.getIn(t, "data.result") || (e = new M(D,"Failed to verify captcha.",{
                                url: m,
                                type: f,
                                token: b.token
                            })),
