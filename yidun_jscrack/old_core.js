        ...
        e.exports = o._extend({
            ...
            methods: {
                ...
                trackMoving: function(e) {
                    if (this.beginTime) {
                        var l_now_deal = l.now() - this.beginTime;

                        var t = this.$bgImg.getBoundingClientRect()
                            , n = t.left
                            , i = t.top
                            , r = f(this.$store.state.token, [Math.round(e.clientX - n), Math.round(e.clientY - i), l_now_deal] + "");
                        console.log(l_now_deal);
                        console.log('trackMoving', e.clientX - n, e.clientY - i, l_now_deal, r);
                        my_trance.push([e.clientX - n, e.clientY - i, l_now_deal]);
                ...
                addPoint: function(e) {
                    ...
                    if (!(i > this.MAX_POINTS)) {
                        ...
                        var time_deal = l.now() - this.beginTime;

                        console.log('addPoint', t, n, time_deal);
                        console.log(f(this.$store.state.token, [Math.round(t), Math.round(n), time_deal] + ""));
                        ...
                        r.className = "yidun_icon-point yidun_point-" + i,
                            ...
                            this.pointsStack.push({
                                el: r,
                                coord: f(this.$store.state.token, [Math.round(t), Math.round(n), time_deal] + "")
                            }),
                ...
                shouldVerifyCaptcha: function() {
                    ...
                    if (e.length === this.MAX_POINTS) {
                        ...
                        console.log(data);
                        console.log(JSON.stringify(my_trance));

                        my_trance = [];
                        this.onVerifyCaptcha(data);
                    }
                },
            ...
            methods: {
                ...
                trackMoving: function(e) {
                    if (this.beginTime) {
                        ...
                        console.log(n, i, l.now() - this.beginTime);
                        this.traceData.push(r)
                    }
                },
                toggleClassicVisible: function(e) {
