        ...
        (function() {
                ...
                (function() {
                        ...
                        (function() {
                                ...
                                function $b(a) {
                                    console.log('$b a:', JSON.stringify(a));
                                    var d = a.C
                                        , m = a.ia
                                        , e = Y().j(ma)
                                        , f = C[b[352]][b[469]].sa;
                                ...
                                ha.prototype.k = function(c, d, e) {
                                    ...
                                    if (d && typeof d === b[427]) {
                                        ...
                                        d = [d, e, F()].join(this.Q);
                                        this.A[c] = d;
                                        console.log('ha.prototype.k  d:', d);
                                        try {
                                            ja.setItem(c, d)
                                        } catch (f) {}
                                    }
                                ...
                                ha.prototype.j = function(a) {
                                    a = this.o(a);
                                    var c = this.A[a];
                                    console.log('ha.prototype.j c', c);
                                    if (!c)
                                        try {
                                            c = ja[b[4]](a),
                                                this.A[a] = c
                                ...
                                }, ac = a[9], Fc = b[622], Gc = [b[103], b[102], b[44], b[44], b[44], b[41], b[47], b[47]], Hc = b[301], Jc = c[31], kb, rb, ta, Ea, D = dc(), rd = function() {
                                    var k = dc();
